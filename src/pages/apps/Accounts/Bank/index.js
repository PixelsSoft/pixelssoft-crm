...
const type=[
    ...
    const ActionColumn = (  {item}  ) => {
        ...
        return (
            <React.Fragment>
                <Link className="action-icon" onClick={() => ViewFunc( item )}>
                    {" "}
                ...
                <Link className="action-icon" onClick={() => deletebank( item.id )}>
                    {" "}
    ...
    const ViewFunc = async ( item ) => {
        setInDate(item?.date);
        setTitle(item?.title);
        setAccNumber(item?.account_Number)
        setCountry(item?.country)
        setAccountType(item?.account_Type)
        setRoutingNumber(item?.routing_number)
        setBankAddress(item?.bank_Address)
        setBankName(item?.bank_Name)
        setIban(item?.iban)
        setSwift(item?.swift)
        setAmount(item?.opening_Balance);
    ...
    const deletebank = async ( id ) => {
        ...
        await dispatch( DeleteBank( id, token ) );
    ...
    const editEx = async ( id ) => {
        ...
        await dispatch(EditBank(selectedId, formData,token))
    ...
    const addBank = async () => {
        if ( inDate === undefined || title === undefined  ) {
        ...
        await dispatch(AddBank(formData,token))
       await     dispatch( stopLoading() );
            reset()
        toggleModal()
    ...
    return loading ? (
        ...
        <>
                    ...
                    <Row className='mb-3'>
                        ...
                        <Col>
                            ...
                            >
                                ...
                                {Currency?.map( val => {
                                    return (
                                        <option key={val.id} value={val.cc}>"({val.cc})" {val.name} </option>
                                    );
                                } )}
                            </FormInput>
                        </Col>
            ...
            {/* Edit Modal */}
            <Modal size="lg" show={exModal} 
            onHide={()=>{setExModal(false)
                reset()
            }}>
                <Modal.Header closeButton>
            ...
            onHide={()=>{setOpenView(false)
                ...
                <Modal.Body className="p-4">
                    <Row className='mb-3'>
                        <Col >
                            <Form.Group as={Col} controlId="formGridState">
                                <Form.Label>Opening Date</Form.Label> :<br/> 
                    ...
                    <Row className='mb-3'>
                        <Col>
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Opening Balance</Form.Label> :<br/> 
                    ...
                    <Col >
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Account Number</Form.Label> :<br/> 
                         
                                <Form.Label>{accNumber}</Form.Label>
                                
                            </Form.Group>
                        </Col>
                    <Col >
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>IBAN</Form.Label> :<br/> 
                                <Form.Label>iban</Form.Label>
                    ...
                    <Col >
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Bank Name</Form.Label> :<br/> 
                    ...
                    <Col >
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Bank Address</Form.Label> :<br/> 
                                <Form.Label>{bankAddress}</Form.Label>
                    ...
                    <Col >
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Swift/BIC</Form.Label> :<br/> 
                    ...
                    <Col >
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Routing number</Form.Label> :<br/> 
                                <Form.Label>{routingNumber}</Form.Label>
