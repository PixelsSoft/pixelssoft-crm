...
//   const { project } = location.state || {}; // Accessing the project data
...
//   }, [project]); // Adding project as a dependency
...
const ProjectDetail = () => {
  ...
  console.log("Location state:", location.state);// access project data from location state
