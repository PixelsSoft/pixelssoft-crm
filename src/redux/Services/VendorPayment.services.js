...
const CreateVendorPayment = async (data, token) => {
  ...
  return await fetch(
    CONSTANTS.API_URLS.BASE + CONSTANTS.API_URLS.vendorPayment,
    options
  )
    .then((response) => {
      if (!response.ok) {
...
const DeleteVendorPayment = async (id, token) => {
  ...
  return await fetch(
    CONSTANTS.API_URLS.BASE + CONSTANTS.API_URLS.vendorPayment + "/" + id,
    options
  )
    .then((response) => {
      if (!response.ok) {
...
const GetVendorPaymentById = async (id, token) => {
  ...
  return await fetch(
    CONSTANTS.API_URLS.BASE +
      CONSTANTS.API_URLS.vendorPayment +
      "/" +
      id +
      "/" +
      CONSTANTS.API_URLS.edit,
    options
  )
    .then((response) => {
      if (!response.ok) {
...
const UpdateVendorPayment = async (data, token) => {
  const onSuccess = (data) => {
    return data;
  };
